    ...
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            <div class="mailbox-open-author">
                <img src="${ base_url +  'Assets/images/intuye.png'}" alt="">
                ...
                <div class="mailbox-open-actions">
                    <a href="#" class="btn btn-danger" onclick="eliminarCompartido(${res.id})">Borrar</a>
                </div>
            </div>
...
function eliminarCompartido(id) {
    ...
    eliminarRegistro('ESTA SEGURO DE ELIMINAR', 'EL ARCHIVO SE ELIMINARÁ COMPARTIDO DESAPARECERÁ DE TU LISTA', 'SI ELIMINAR', url, null)
