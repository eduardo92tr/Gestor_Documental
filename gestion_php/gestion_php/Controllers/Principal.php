...
require 'D:\xampp\htdocs\gestion_php\vendor/autoload.php';
    ...
    public function validar()
    {
        ...
        if (!empty($data)) {
            if (password_verify($clave, $data['clave'])) {
                ...
                $res = array('tipo' => 'warning', 'mensaje' => 'LA CONSTRASEÑA ES INCORRECTA');
            }
        } else {
    ...
    public function enviarCorreo($correo)
    {
        ...
        if (!empty($consulta)) {
            ...
            try {
                ...
                $mail->Username   = 'eduardomrr92@gmail.com';
                //    $mail->Username   = 'eduardomr_@hotmail.com';                      //SMTP username
                //   $mail->Password   = 'wsagwliztuiwofgk';                     //hotmail
                $mail->Password   = 'uyummtxnlcivyheg';                     //Gmail creado
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                //Recipients
                $mail->setFrom('antlean90@icloud.com', 'sistema-gestor');  //A quien le llega el correo

                // $mail->setFrom('eduardomrr92@gmail.com', 'Edu_php');
            ...
            if ($nueva != $confirmar) {
                ...
                if ($token ==  $result['token']) {
                    ...
                    if ($data == 1) {
                        ...
                        $res = array('tipo' => 'warning', 'mensaje' => 'ERROR AL RESTABLECER LA CONTRASEÑA');
                    }
                }
            }
        }
