...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <div class="logo">
                <a href="index.html">Pagina de inicio de sesión</a>
            </div>
            <p class="auth-description">Bienvenido al sistema de gestor de archivos de Intuye.<br>¿No tiene una cuenta? <a href="sign-up.html">Inscribirse</a></p>

            <form id="formulario" autocomplete="off">
                <div class="auth-credentials m-b-xxl">
                    <label for="correo" class="form-label">Dirección de Correo <span class="text-danger">*</span></label>
